public class TextHandler {
    ...
    public void process(int a) {
        ...
        p.sendQuest("@whi@", 949);
        p.sendQuest("@whi@", 950);
        p.sendQuest("      @gre@TelePort's", 174);
        ...
        // ----Friends & Ignores----
        p.sendQuest("@bla@Friends List", 5067);
        p.sendQuest("@bla@Ignore List", 5717);
        p.sendQuest("@bla@Add Friend", 5070);
        p.sendQuest("@bla@Del Friend", 5071);
        p.sendQuest("@bla@Add Name", 5720);
        p.sendQuest("@bla@Del Name", 5721);
        ...
        p.sendQuest("@whi@Teleport To Varrock.", 1301);
        ...
        p.sendQuest("@whi@Teleport To Lumby.", 1326);
        ...
        p.sendQuest("@whi@Teleport to falador.", 1351);
        ...
        p.sendQuest("@whi@Teleport to camelot.", 1383);
