...
public static int jad[] = {995};
    ...
    public static int hammember[] = {882,1351,1205,1265,1349,1267,886,1353,1207,1269,1129,4298,4300,4302,4304,4306,4308,4310};

    public static int randomhammember()
    {
    		return hammember[(int)(Math.random()*hammember.length)];
    }
    public static int Phat[] = {1038,1040,1042, 1044, 1046, 1048, 9091};
